class Initial < ActiveRecord::Migration[4.2]
  ...
  create_table "actions", id: :serial, force: :cascade do |t|
    ...
    t.index ["external_id", "technical_type"], name: "index_actions_on_external_id_and_technical_type", unique: true
  ...
  create_table "member_actions", force: :cascade do |t|
    ...
    t.index ["member_id"], name: "index_member_actions_on_member_id"
